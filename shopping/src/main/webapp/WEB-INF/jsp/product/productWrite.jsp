							...
							<div class="jsx-2303464893 editor">
								<div class="fr-box fr-basic fr-top" role="application">
									<div class="fr-wrapper show-placeholder" dir="auto" style="overflow: scroll;">
										<textarea rows="5" cols="8" name="content" id="content" style="width:900px;"></textarea>
									</div>
								</div>
							</div>
<!-- 
							<textarea rows="5" cols="8" name="content" id="content" style="width:500px;"></textarea> -->
						</td>
					</tr> 
		 			<tr>
	                     <th>첨부파일</th>
     ...
     <script type="text/javascript" src ="/resources/naverEditor/js/HuskyEZCreator.js"></script>
