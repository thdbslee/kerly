                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i>test@naver.com</li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                        	<li><a href="/category/shop.do">전 체 상 품</a></li>
                            <c:forEach var="menuList" items="${menuList}">
                            	<li><a href="#" onclick="fn_menu('${menuList.INX}')">${menuList.CATE_NAME}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form id="searchFrm" name="searchFrm" method="post">
                                ...
                                <input type="text" placeholder="What do yo u need?" id="searchKeyword" name="searchKeyword" value="${vo.searchKeyword}">
	...
	<script>
		...
		function fn_search(){
			if(!$("#searchKeyword").val()){
		 	...
		 	document.searchFrm.action = '/category/shop.do';
			$("#searchFrm").submit();
