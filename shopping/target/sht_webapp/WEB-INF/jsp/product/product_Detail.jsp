                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="./index.html">${vo.category}</a>
                            <span>${vo.p_name}</span>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="/upload/${vo.IMG_1 }" alt="상품메인이미지">
                        </div>
             ...
             <form name="form" id="form" method="post"> 
           		...
           		<input type="hidden" id="P_INX" name="P_INX" value="${vo.INX}">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <a href="javascript:fn_purchase()" class="primary-btn">장바구니 담기</a>
                     <%--    <c:if test="${loginvo.AUTHCODE eq 9 }"> --%>
                        	<a href="#" onclick="fn_edit()" class="primary-btn">수정하기</a>
                        <%-- </c:if> --%>
